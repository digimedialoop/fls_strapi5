...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    company2: Schema.Attribute.String;
    ...
    lead: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    invoicepositions: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoiceposition.invoiceposition'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInvoicepositionInvoiceposition
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    offerpositions: Schema.Attribute.Relation<
      'manyToMany',
      'api::offerposition.offerposition'
    >;
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    offerdate: Schema.Attribute.Date;
    offernumber: Schema.Attribute.String;
    ...
    tax: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<19>;
    pretext: Schema.Attribute.Blocks;
...
export interface ApiOfferpositionOfferposition
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    projecttasks: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProjecttaskProjecttask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    offerposition: Schema.Attribute.Relation<
      'manyToOne',
      'api::offerposition.offerposition'
    >;
    taskstatus: Schema.Attribute.String & Schema.Attribute.DefaultTo<'todo'>;
    projecttimes: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProjecttimeProjecttime extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    projecttask: Schema.Attribute.Relation<
      'manyToOne',
      'api::projecttask.projecttask'
    >;
    chargeable: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    description: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::invoiceposition.invoiceposition': ApiInvoicepositionInvoiceposition;
      'api::offer.offer': ApiOfferOffer;
      'api::offerposition.offerposition': ApiOfferpositionOfferposition;
      'api::project.project': ApiProjectProject;
      'api::projecttask.projecttask': ApiProjecttaskProjecttask;
      'api::projecttime.projecttime': ApiProjecttimeProjecttime;
